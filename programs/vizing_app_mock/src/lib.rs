...
declare_id!("mokfsGhmaCUURb7CoVTkfUbYgUibpMSaWz9iUsrHg8K");

pub const RESULT_DATA_SEED: &[u8] = b"result_data_seed";

// example: 0x922BEA61bc185c4Ef7cF24bd1B4123a50676d6E8
pub const TRUSTED_ENDPOINT: [u8; 32] = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x92, 0x2b, 0xea, 0x61,
    0xbc, 0x18, 0x5c, 0x4e, 0xf7, 0xcf, 0x24, 0xbd, 0x1b, 0x41, 0x23, 0xa5, 0x06, 0x76, 0xd6, 0xe8,
];
