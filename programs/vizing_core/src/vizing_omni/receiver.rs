...
#[derive(Accounts)]
pub struct VizingInitialize<'info> {
    #[account(init, payer = admin, space = 8 + VizingSolReceiver::INIT_SPACE, seeds = [VIZING_APP_SOL_RECEIVER_SEED], bump)]
