...
describe("Vizing Test", () => {
  it("Test", async () => {
    ...
    const vizingCallTestProgram = anchor.workspace
      .VizingCallTest as Program<VizingCallTest>;
    ...
    const [vizingPadConfigAuthority, vizingPadConfigBump] =
    ...
    console.log(
      "recordMessageAccount:",
      recordMessageAccount.publicKey.toBase58()
    );
    ...
    async function Initialize() {
      const initializ = await vizingCallTestProgram.methods
        .initialize()
        .accounts({
    ...
    async function TestGetComputeTradeFee1(chainId, amountOut) {
      const getComputeTradeFee1 = await vizingCallTestProgram.methods
        .getComputeTradeFee1(chainId, amountOut)
        .accounts({
      ...
      const testRecordAccount =
        await vizingCallTestProgram.account.testRecordAccount.fetch(
    ...
    //
    let testTargetContract = Buffer.from(
      "0xdAC17F958D2ee523a2206206994597C13D831ec7"
    );
    async function TestGetComputeTradeFee2(targetContract, chainId, amountOut) {
      const getComputeTradeFee2 = await vizingCallTestProgram.methods
        .getComputeTradeFee2(targetContract, chainId, amountOut)
        .accounts({
          vizingGasSystem: mappingFeeConfigAuthority,
          currentRecordMessage: recordMessageAuthority,
          recordMessage: recordMessageAccount.publicKey,
    ...
    await TestGetComputeTradeFee2(
      testTargetContract,
      dest_chain_id,
      computeTradeFee1AmountOut
    );

    //get_estimate_price1
    async function TestGetEstimatePrice1(targetContract, chainId) {
      const getEstimatePrice1 = await vizingCallTestProgram.methods
        .getEstimatePrice1(targetContract, chainId)
        .accounts({
          vizingGasSystem: mappingFeeConfigAuthority,
          currentRecordMessage: recordMessageAuthority,
          recordMessage: recordMessageAccount.publicKey,
    ...
    async function TestGetEstimatePrice2(chainId) {
      const getEstimatePrice2 = await vizingCallTestProgram.methods
        .getEstimatePrice2(chainId)
        .accounts({
          vizingGasSystem: mappingFeeConfigAuthority,
          currentRecordMessage: recordMessageAuthority,
          recordMessage: recordMessageAccount.publicKey,
    ...
    async function TestGetEstimateGas(amountOut, chainId, message) {
      const getEstimateGas = await vizingCallTestProgram.methods
        .getEstimatePrice2(amountOut, chainId, message)
        .accounts({
          vizingGasSystem: mappingFeeConfigAuthority,
          currentRecordMessage: recordMessageAuthority,
          recordMessage: recordMessageAccount.publicKey,
    ...
    async function TestGetEstimateTotalFee(chainId, amountOut, message) {
      const getEstimateTotalFee = await vizingCallTestProgram.methods
        .getEstimateTotalFee(chainId, amountOut, message)
        .accounts({
          vizingGasSystem: mappingFeeConfigAuthority,
          currentRecordMessage: recordMessageAuthority,
          recordMessage: recordMessageAccount.publicKey,
    ...
    await TestGetEstimateTotalFee(
      dest_chain_id,
      estimateGasAmountOut,
      newMessage
    );
    ...
    async function TestGetExactOutput(chainId, amountOut) {
      const getExactOutput = await vizingCallTestProgram.methods
        .getExactOutput(chainId, amountOut)
        .accounts({
          vizingGasSystem: mappingFeeConfigAuthority,
          currentRecordMessage: recordMessageAuthority,
          recordMessage: recordMessageAccount.publicKey,
    ...
    async function TestGetExactInput(chainId, amountIn) {
      const getExactInput = await vizingCallTestProgram.methods
        .getExactInput(chainId, amountIn)
        .accounts({
          vizingGasSystem: mappingFeeConfigAuthority,
          currentRecordMessage: recordMessageAuthority,
          recordMessage: recordMessageAccount.publicKey,
    ...
    async function TestGetEstimateVizingGasFee1(
      value,
      chainId,
      additionParams,
      message
    ) {
      const getEstimateVizingGasFee1 = await vizingCallTestProgram.methods
        .getEstimateVizingGasFee1(value, chainId, additionParams, message)
        .accounts({
          vizingGasSystem: mappingFeeConfigAuthority,
          currentRecordMessage: recordMessageAuthority,
          recordMessage: recordMessageAccount.publicKey,
    ...
    await TestGetEstimateVizingGasFee1(
      estimateGasAmountOut,
      dest_chain_id,
      newAdditionParams,
      newMessage
